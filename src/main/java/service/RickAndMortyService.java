...
public class RickAndMortyService extends BaseService{
    ...
    public ReadableResponse getAllCharacters() { return getRequest("/character"); }

    public ReadableResponse getASingleCharacter(Integer id) { return getRequest("/character/" + id); }
